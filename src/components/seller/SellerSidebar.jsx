  ...
  return (
    <aside className="hidden md:flex h-screen w-64 fixed left-0 top-0 z-40 bg-[#f6f2f8] flex-col p-6 gap-2 font-['Plus_Jakarta_Sans'] font-medium text-[#15157d]">
      <div className="mb-10 px-2">
        ...
        <p className="text-xs text-[#1b1b1f]/60 mt-1 uppercase tracking-wider">The Digital Curator</p>
      </div>
      ...
      <div className="mt-auto space-y-4">
        ...
        <div className="flex items-center gap-3 px-2 pt-4 border-t border-outline-variant/20">
          <img alt="Seller Profile" className="w-10 h-10 rounded-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBi3Dho0MjP66VJu4kYQ9V0ijWPW9C5s8-p1Ntzj6VJgQGtb4hs7-TASXK2ABMsNn7iK-GLslbFHHFgWLHrscR6rcUkUFr6Y0pXRGlAQdPO6vXUnZsXx3CPSuow23PnWqu7l6kKOYLw6ixDWa03Z9YJ5JvUKw_ybpxxQBnXrdWpvDtvic8xqi4A6Pg-jCqhb8j2r1haIkju6fl6gzEaZAGNvlc6MeBZyDPyUSVI2_H0RRbnRlGCePXfirnuofmvhbd4GzoExZindOk" />
          <div className="overflow-hidden">
            <p className="text-sm font-bold truncate">Arjun Mehta</p>
            <p className="text-[10px] opacity-60 truncate">Curator Level 4</p>
          </div>
        </div>
      </div>
    </aside>
